...
class BankDemo:
    ...
    def readWriteFixedDeposit(self):        
        ...
        print("Final amount with simple interest: ", fd.get_amount() + (fd.get_amount() * fd.get_duration() * fd.get_rate_of_interest() / 100))
    ...
    def readWriteRecurringDeposit(self):
        ...
        print("Final amount with simple interest: ", (rd.get_monthly_payment() * 12) + (rd.get_monthly_payment() * 12 * rd.get_rate_of_interest() * rd.get_duration() / 100))
